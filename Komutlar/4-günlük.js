...
if (!banka) return message.channel.send(new MessageEmbed().setDescription(`${message.author} Bilgilerini Kaydetmem İçin Bir Banka Hesabı Oluşturmalısın! \n<a:bytcec:818712678146113567> **g.banka hesap oluştur**`))
        ...
        if(author !== null && timeout - (Date.now() - author) > 0){
            ...
            message.channel.send(new MessageEmbed().setDescription(`<a:bytcec:818712678146113567> Günlük ödülünden **${amount}** ${settings.para.parabirimi || "Coin"} kazandın. <a:ucanpara:768793827569565726>`))
